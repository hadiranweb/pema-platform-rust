...
use crate::services::admin_service::{AdminService, Product, CreateProduct, AdminProductUpdateDto};
...
pub fn admin_products_page() -> Html {
    ...
    let fetch_products = { 
        ...
        Callback::from(move |_| {
            ...
            wasm_bindgen_futures::spawn_local(async move {
                ...
                match AdminService::get_all_products().await {
                    Ok(products) => {
    ...
    let on_delete_product_click = { 
        ...
        Callback::from(move |product_id: String| {
            let fetch_products = fetch_products.clone();
            wasm_bindgen_futures::spawn_local(async move {
                match AdminService::delete_product(product_id).await {
                    Ok(_) => {
